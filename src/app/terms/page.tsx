...
export const metadata = {
  title: 'Vilkår og betingelser — HeyBox',
}
        ...
        <div className="space-y-10 text-zinc-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              Kontakt: <a href="mailto:hej@heybox.dk" className="underline text-black">hej@heybox.dk</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              <a href="mailto:hej@heybox.dk" className="underline text-black">hej@heybox.dk</a>.
            </p>
            <p>
